...
<div class="w-full flex flex-col mb-8 rounded-leon bg-dark_two">
          ...
          <div class="w-full flex items-center justify-between">
              ...
              <div class="flex items-center">
                  ...
                  <div class="flex items-center">
                    ...
                    <div class="font-weight-lighter text-gray_two cursor-default">
                      {{ $article->updated_at->format('Y/m/d H:i') }}に投稿
                    </div>
                  </div>
              </div>
